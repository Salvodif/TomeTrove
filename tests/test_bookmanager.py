...
class TestBookManagerFunctionality(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.initial_filename = f"{self.initial_author_fsname} - {self.initial_filename_stem}{self.initial_ext}"
    ...
    def _clear_all_books(self):
        ...
        all_books = list(self.book_manager.get_all_books())
    ...
    def test_change_title(self):
        ...
        new_filename_expected = f"{self.initial_author_fsname} - {new_filename_expected_stem}{self.initial_ext}"
        ...
        updated_book = self.book_manager.get_book(self.book_uuid)
    ...
    def test_change_author(self):
        ...
        new_filename_expected = f"{new_author_fsname} - {self.initial_filename_stem}{self.initial_ext}"
    ...
    def test_change_title_and_author(self):
        ...
        new_filename_expected_stem = FormValidators.title_to_fsname(new_title)
        new_author_fsname = FormValidators.author_to_fsname(new_author)
        new_filename_expected = f"{new_author_fsname} - {new_filename_expected_stem}{self.initial_ext}"
    ...
    def test_update_book_with_no_initial_filename_and_no_file(self):
        ...
        expected_author_fsname = FormValidators.author_to_fsname(no_file_author)
        expected_new_filename = f"{expected_author_fsname} - {FormValidators.title_to_fsname(updated_title)}.epub"

        self.book_manager.update_book(no_file_uuid, {"title": updated_title})

        updated_book = self.book_manager.get_book(no_file_uuid)
    ...
    def test_file_extension_preservation(self):
        ...
        ext_filename = f"{ext_author_fsname} - {ext_filename_stem}{ext_actual}"
        ...
        new_filename_expected = f"{ext_author_fsname} - {new_filename_expected_stem}{ext_actual}"
        ...
        updated_book = self.book_manager.get_book(ext_book_uuid)
